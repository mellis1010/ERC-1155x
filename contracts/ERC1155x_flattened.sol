...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        ...
        require(id < MAX_SUPPLY, "ERC1155x: id exceeds maximum");
    ...
    function _mint(
        ...
        require(amount < 2, "ERC1155x: exceeds supply");
        require(id < MAX_SUPPLY, "ERC1155x: invalid id");
    ...
    function _mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            require(amounts[i] < 2, "ERC1155x: exceeds supply");
            require(_owners[ids[i]] == address(0), "ERC1155x: supply exceeded");
    ...
    function _prepayGas(uint256 start, uint256 end) internal {
        require(end <= MAX_SUPPLY, "ERC1155x: end id exceeds maximum");
    ...
    function ownerOfERC721Like(uint256 id) external view returns(address) {
        require(id < _owners.length, "ERC1155x: id exceeds maximum");
        address owner = _owners[id];
        require(owner != address(0), "ERC1155x: owner query for nonexistent token");
        return owner;
    }
